...
final class ApiLoader {
	...
	public function controller($route, $data = array()) {
		...
		$result = $this->registry->get('event')->trigger('api/controller/' . $trigger . '/before', array(&$route, &$data));
		...
		$result = $this->registry->get('event')->trigger('api/controller/' . $trigger . '/after', array(&$route, &$data, &$output));
	...
	public function language($route, $key = '') {
		...
		$result = $this->registry->get('event')->trigger('api/language/' . $trigger . '/before', array(&$route, &$key));
		...
		$result = $this->registry->get('event')->trigger('api/language/' . $trigger . '/after', array(&$route, &$key, &$output));
